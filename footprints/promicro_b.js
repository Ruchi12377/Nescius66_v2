...
module.exports = {
  ...
  body: p => {
    const standard = `
      (module ProMicro (layer B.Cu) (tedit 5B307E4C)
    ...
    function pins(def_neg, def_pos) {
      return `
        ...
        (fp_line (start -15.24 ${def_pos}6.35) (end -12.7 ${def_pos}6.35) (layer B.SilkS) (width 0.15))
        (fp_line (start -15.24 ${def_pos}6.35) (end -15.24 ${def_pos}8.89) (layer B.SilkS) (width 0.15))
        (fp_line (start -12.7 ${def_pos}6.35) (end -12.7 ${def_pos}8.89) (layer B.SilkS) (width 0.15))
        ...
        (fp_text user P21 (at -3.81 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P20 (at -1.27 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P19 (at 1.27 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P18 (at 3.81 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P15 (at 6.35 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P14 (at 8.89 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P16 (at 11.43 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P10 (at 13.97 ${def_pos}4.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
      
        (fp_text user P01 (at -13.97 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P00 (at -11.43 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user GND (at -8.89 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user GND (at -6.35 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P02 (at -3.81 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P03 (at -1.27 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P04 (at 1.27 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P05 (at 3.81 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P06 (at 6.35 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P07 (at 8.89 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P08 (at 11.43 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        (fp_text user P09 (at 13.97 ${def_neg}10.8 ${p.r + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
